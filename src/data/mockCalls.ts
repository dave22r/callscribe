...
export const mockCalls: EmergencyCall[] = [
  ...
  },
  {
    ...
    urgency: 'urgent',
    status: 'queued',
    summary: '52-year-old female, severe chest pain and shortness of breath. Possible cardiac event.',
    symptoms: ['chest pain', 'shortness of breath', 'sweating', 'left arm pain'],
